// STONEWORKS CUSTOM SHENANIGANS - NOTE FROM MOYYE - YES! THIS ENTIRE FILE
	...
	public static NamedRanges fromConfigSection(ConfigurationSection sec) {
        ...
        for (String k : sec.getKeys(false)) {
            ...
            try {
                ...
                BreweryPlugin.getInstance().errorLog("Tried to create a named range but got something that isn't a number: '" + k + "'!");
                return null;
			}
